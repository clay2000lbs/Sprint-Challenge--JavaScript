...
*/
const populationTotal = zooAnimals.reduce((totalAnimals,zooAnimals) => totalAnimals + zooAnimals.population, 0);
...
function add(intergerOne,intergerTwo) {
  return intergerOne + intergerTwo;
}

function multiply(intergerOne,intergerTwo) {
  return intergerOne * intergerTwo;
}
